...
$.fn.embedBehance = function(options) {
    ...
    $(behanceContainer).html('<ul class="wrap-projects row"></ul>');
    ...
    function designTemplate(token, value) {
        ...
        switch (token) {
            ...
            case 'title':
                ...
                dataWrapper += '<div class="wrap-title"><strong>' + value.name + '</strong></div>';
    ...
    function printContentForList() {
        ...
        $.each(dataExtracted, function(key, value) {
            ...
            // wrap all the data belongs to one project and append the wrapper
            html = '<li class="wrap-project col-4 col-med-6 col-sml-12">' + html + '</li>';
